...
- Base Abilities have the exact range 1 through 10; base Skills have the
...
- Diagnostic records retain only bounded safe identifiers, normalized relative
  ...
  information.
- The valid fixture resolves Ability, Skill, Access, training, Feat, Race,
...
automatic dependency downloads, adding arbitrary Abilities from public mods,
...
Future content kinds beyond Ability, Skill, Access, Feat, Perk, Race, and
